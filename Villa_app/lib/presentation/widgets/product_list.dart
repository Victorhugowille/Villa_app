...
class ProductList extends StatefulWidget {
  final app_data.Product? selectedProduct;
  final Function(app_data.Product) onProductSelected;
...
class _ProductListState extends State<ProductList> {
  List<app_data.Product> _localProducts = [];
  ...
  void _syncLocalList() {
    ...
    if (mounted) {
      setState(() {
        _localProducts = List<app_data.Product>.from(productProvider.products);
      });
    }
  }

  Future<void> _handleReorder(int oldIndex, int newIndex,
      List<app_data.Product> productsInCategory, app_data.Category category) async {
    ...
    setState(() {
      ...
      final List<app_data.Product> updatedFullList = [];
