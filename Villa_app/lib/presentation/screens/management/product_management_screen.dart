...
class _ProductManagementScreenState extends State<ProductManagementScreen> {
  app_data.Product? _selectedProduct;
          ...
          SizedBox(
            ...
            child: ProductList(
              ...
              onProductSelected: (product) {
                setState(() {
                  _selectedProduct = product as app_data.Product?;
                });
              },
            ),
          ),
      ...
      builder: (context, productProvider, child) {
        ...
        return RefreshIndicator(
          ...
          child: ProductList(
            onProductSelected: (product) {
              navProvider.navigateTo(
                  context, ProductEditScreen(product: product as app_data.Product?), 'Editar Produto');
            },
          ),
        );
      },
