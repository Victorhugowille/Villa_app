...
class _CategoryManagementScreenState extends State<CategoryManagementScreen> {
  List<app_data.Category> _localCategories = [];
  ...
  void _syncLocalList() {
    if (!mounted) return;
    setState(() {
      _localCategories = List<app_data.Category>.from(
  ...
  Future<void> _confirmDeleteCategory(app_data.Category category) async {
  ...
  Future<void> _onReorder(int oldIndex, int newIndex) async {
    ...
    setState(() {
      ...
      final app_data.Category item = _localCategories.removeAt(oldIndex);
