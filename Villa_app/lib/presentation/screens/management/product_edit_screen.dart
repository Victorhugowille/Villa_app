...
class _ProductEditScreenState extends State<ProductEditScreen> {
  ...
  app_data.Product? _currentProduct;
  bool get _isEditMode => _currentProduct != null;

  List<app_data.Category> _availableCategories = [];
  bool _isLoading = true;
  bool _isSaving = false;
  XFile? _imageFile;
  final ImagePicker _picker = ImagePicker();

  List<app_data.GrupoAdicional> _localGrupos = [];
  ...
  Future<void> _onReorderAdicional(
      int oldIndex, int newIndex, app_data.GrupoAdicional grupo) async {
    setState(() {
      if (newIndex > oldIndex) {
        newIndex -= 1;
      }
  ...
  // **MUDANÇA AQUI**
  void _showGrupoDialog({app_data.GrupoAdicional? grupo}) {
  ...
  void _showAdicionalDialog({app_data.Adicional? adicional, required String grupoId}) {
