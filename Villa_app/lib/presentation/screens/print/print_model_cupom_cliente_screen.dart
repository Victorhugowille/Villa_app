...
class _ReceiptLayoutEditorTabState extends State<ReceiptLayoutEditorTab> {
  ...
  void _printTest(dynamic settings) async {
  ...
  Widget _buildControlsPanel(dynamic settings) {
  ...
  Widget _buildLogoEditor(dynamic settings) {
    return Card(
  ...
  Widget _buildInfoEditor(dynamic settings) {
    final company =
