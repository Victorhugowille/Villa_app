...
class _JoinCompanyScreenState extends State<JoinCompanyScreen> {
  ...
  final _fullNameController = TextEditingController(); // <-- NOVO CONTROLLER
  ...
  void initState() {
    super.initState();
    // Dados de teste
    _fullNameController.text = 'Funcionário Teste'; // <-- DADO NOVO
  ...
  void dispose() {
    ...
    _fullNameController.dispose(); // <-- DISPOSE NOVO
    super.dispose();
  }
  ...
  Future<void> _submitJoinRequest() async {
    ...
    try {
      final response = await Supabase.instance.client.functions.invoke(
        ...
        body: {
          'full_name': _fullNameController.text.trim(), // <-- DADO NOVO
          'email': _emailController.text.trim(),
          'password': _passwordController.text.trim(),
          'phone': _phoneMaskFormatter.unmaskText(_phoneController.text),
          'companyCnpj':
              _cnpjMaskFormatter.unmaskText(_companyCnpjController.text),
        },
      );
      if (mounted) {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'Seu email de acesso'),
