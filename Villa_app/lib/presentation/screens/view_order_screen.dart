          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (ctx, i) {
                ...
                return ListTile(
                  title: Text(item.product.name, style: TextStyle(color: theme.colorScheme.onSurface)),
                  subtitle: Text('Qtd: ${item.quantity}', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.7))),
                  trailing: Text(
