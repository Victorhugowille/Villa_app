  ...
  Widget _buildBottomControls(ThemeData theme) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
              TextButton(onPressed: _completeOnboarding, child: Text('PULAR', style: TextStyle(color: theme.colorScheme.onSurface))),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 40),
              Text(title, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: theme.colorScheme.onSurface)),
              const SizedBox(height: 16),
              Text(description, textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: theme.colorScheme.onSurface.withOpacity(0.8))),
        ],
      ),
    );
  }
