...
// --- MUDANÇA 1: Importar a nova tela ---
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // --- MUDANÇA 2: Duas variáveis de aceite (ALTERADO PARA TRUE PARA TESTES) ---
  ...
  Future<void> _submit() async {
    ...
    // --- MUDANÇA 3: Validar os dois aceites ---
  ...
  // --- MUDANÇA 4: Função para mostrar a tela de aceite ---
  Future<void> _showTermsDialog(String type) async {
    ...
    if (type == 'privacy') {
      ...
      content = _privacyPolicyText; // Texto definido abaixo
    } else {
      title = 'Termos de Uso';
      content = _termsOfUseText; // Texto definido abaixo
    }

    // Chama a nova tela como uma página (fullscreen dialog)
    ...
    // Se o usuário clicou em "ACEITO" (retornou true)
    if (result == true) {
      if (mounted) {
        setState(() {
          if (type == 'privacy') {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16), // Aumentei o espaço

                    // --- MUDANÇA 5: Substituir Checkbox por ListTile ---
                    // Esta é a nova seção de aceite
                    Container(
  ...
  // --- MUDANÇA 6: Textos de placeholder ---
  // (Substitua este texto pelo seu conteúdo jurídico real)
...
"""; // Adicione mais texto para forçar a rolagem
