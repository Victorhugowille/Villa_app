...
import 'package:villabistromobile/screens/management/management_screen.dart'; // CAMINHO CORRIGIDO AQUI
...
import 'package:villabistromobile/screens/whatsapp_web_screen.dart';
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () => _navigateTo(context, const TransactionsReportScreen(),
